...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        pcs.add(new PC(2, "PC02", "Office", "Intel i5, 8GB RAM, Integrated GPU", 20000));
    ...
    private static void showPC() {
        ...
        for (PC pc : pcs) {
            System.out.println(pc.getId() + " | " + pc.getName() + " | " + pc.getCategory() + " | " + pc.getConfig()
                    + " | " + pc.getPrice());
        }
    }
    ...
    private static void showFood() {
        ...
        for (Food f : foods) {
            System.out.println(f.getId() + " | " + f.getName() + " | " + f.getDescription() + " | " + f.getPrice()
                    + " | Stock: " + f.getStock());
        }
    }
    ...
    private static void editFood() {
        ...
        int id = Integer.parseInt(sc.nextLine());
        Food f = foods.stream().filter(food -> food.getId() == id).findFirst().orElse(null);
        if (f == null) {
    ...
    private static void showDrink() {
        ...
        for (Drink d : drinks) {
            System.out.println(d.getId() + " | " + d.getName() + " | " + d.getDescription() + " | " + d.getPrice()
                    + " | Stock: " + d.getStock());
        }
    }
    ...
    private static void editDrink() {
        ...
        int id = Integer.parseInt(sc.nextLine());
        Drink d = drinks.stream().filter(drink -> drink.getId() == id).findFirst().orElse(null);
        if (d == null) {
